...
if ticker_input:
    ...
    if st.button("📈 Run Analysis"):
        with st.spinner("Fetching data and computing portfolio..."):
            ...
            fig2.add_annotation(x=VaR_pct, y=15, text=f"VaR 95%: {VaR_pct:.2f}%", showarrow=True, arrowhead=1, ax=60)
            fig2.add_annotation(x=CVaR_pct, y=15, text=f"CVaR 95%: {CVaR_pct:.2f}%", showarrow=True, arrowhead=1, ax=-80)
