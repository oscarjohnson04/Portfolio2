...
# Convert to DataFrame and format
            ...
            fig2.add_annotation(x=VaR_pct, y=-10, text=f"VaR 95%: {VaR_pct:.2f}%", showarrow=True, arrowhead=1, ax=60)
            fig2.add_annotation(x=CVaR_pct, y=-10, text=f"CVaR 95%: {CVaR_pct:.2f}%", showarrow=True, arrowhead=1, ax=-80)
